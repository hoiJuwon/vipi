...
Keep regular TUI, explicit REVIEW, fixed 45-column tree, GPT-6 Sol/high default, Korean Direct, and disabled IME switching unless requested otherwise. Do not delete permanent integration branches. Do not rewrite the private submodule remote to a local filesystem URL. Runtime registries, sessions, auth, APNs keys, MCP cache, attachments, model caches, and iOS pairing tokens stay outside this repository.
